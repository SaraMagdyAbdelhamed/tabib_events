              ...
              <div class="side">
                <ul class="side-menu">
                  ...
                  <li class="side__list openedmenu">
                    <a class="side__item " id="sub_8_1" href="{{route('events')}}">@lang('keywords.events')</a>
                  </li>

                  {{-- Reports & Statistics --}}
                  <li class="side__list openedmenu">
                    <a class="side__item" id="sub_8_2" href="{{ route('reports_and_statistics')  }}">@lang('keywords.ReportsِِِِِِAndStatistics')</a>
                  </li>

                  {{-- Offers & Deals --}}
                  <li class="side__list openedmenu">
                    <a class="side__item " id="sub_8_3" href="{{route('offers_and_deals')}}">@lang('keywords.offers_and_deals')</a>
                  </li>
