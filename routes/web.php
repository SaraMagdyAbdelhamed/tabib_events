...
Route::middleware(['auth', 'Rule:Super Admin,Admin Doctor,Data Entry,Organizer,Sponsor'])->group( function($lang = null) {
    ...
    Route::middleware(['auth', 'Rule:Super Admin,Admin Doctor,Data Entry,Organizer,Sponsor'])->group( function($lang = null) {
        ...
        Route::post('/events_destroy', '\Modules\Events\Http\Controllers\EventsController@destroy')->name('events.destroy');
    ...
    Route::middleware(['auth', 'Rule:Super Admin,Admin Doctor,Data Entry,Organizer,Sponsor'])->group(function ($lang = null) {
        ...
        Route::post('/users_mobile/status/update', '\Modules\UsersModule\Http\Controllers\DoctorsController@status_update')->name('users_mobile.status.update');
...
Route::get("/mark_read/{id}/{route}","HomeController@mark_read")->name('mark_read');
