                              ...
                              <table class="data-table-trigger table-master" id="dataTableTriggerId_001">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><span class="cellcontent">{{$answer->name}}</span></td>
                                    @endforeach
                              ...
                              <table class="data-table-trigger table-master" id="dataTableTriggerId_002">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><span class="cellcontent">{{$ticket->barcode}}</span></td>
                                    <td><span class="cellcontent">{{$ticket->serial_number}}</span></td>
                                    <td><span class="cellcontent">
                                      {{$ticket->is_used ? 'Booked' : 'Available'}}
                                    </span></td>
                                    <td><span class="cellcontent">{{$ticket->booking->user->username}}</span></td>
                                    <td><span class="cellcontent">{{$ticket->booking->user->created_at}}</span></td>
                                  </tr>
                                  @endforeach
                                </tbody>
                              </table>
