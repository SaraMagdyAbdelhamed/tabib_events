            ...
            <div class="col-xs-6">
              <div class="master_field">
                ...
                <input class="master_input" type="text" maxlength="100" minlength="2" id="workshop_name" name="workshop[0][name]">
                  @if ( $errors->has('workshop[0][name]') )                   
                    <span class="master_message color--fadegreen">{{ $errors->first('workshop[0][name]') }}</span>                 
                  @endif
              </div>
            </div>
            <div class="col-xs-6">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <div class="master_field">
                ...
                <input class="master_input" type="text" maxlength="100" minlength="10" id="survey_question" name="survey[0][question][0][name]" Required>
            ...
            <div class="col-xs-6">
              <div class="master_field">
                ...
                <input class="master_input" type="text" maxlength="100" id="survey_answer1" name="survey[0][question][0][answer][0]" Required>
            ...
            <div class="col-xs-6">
              <div class="master_field">
                ...
                <input class="master_input" type="text" maxlength="100" id="survey_answer2" name="survey[0][question][0][answer][1]" Required>
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <div class="master_field">
                ...
                <input class="master_input" type="url" placeholder="ex:www.youtube.com/video_iD" id="YouTube_video_link_1" name="event[youtube][0]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
              </div>
            </div>
            <div class="col-xs-6">
              <div class="master_field">
                <label class="master_label" for="YouTube_video_link_2">رابط ال youtube 2</label>
                <input class="master_input" type="url" placeholder="ex:www.youtube.com/video_iD" id="YouTube_video_link_2" name="event[youtube][1]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
              </div>
            </div>
            <div class="col-xs-12">
              <hr>
...
=======
                          ...
                          <div class="col-xs-6">
                            <div class="master_field">
                              ...
                              <input class="master_input" type="text" maxlength="50" minlength="5" id="event_address" name="event[place]" ><span class="master_message color--fadegreen">validation message will be here</span>
                            </div>
                          </div>
                           <div class="col-xs-4" hidden>
                            <div class="master_field">
                              <label class="master_label" for="shop_long">Longtiuide</label>
                              <input class="master_input" name="event[long]" id="event_long" placeholder="event_long" type="text"><span class="master_message inherit">message content</span>
                            </div>
                          </div>
                          <div class="col-xs-4" hidden>
                            <div class="master_field">
                              <label class="master_label" for="shop_lat">Lat</label>
                              <input class="master_input" name="event[lat]" id="event_lat" placeholder="event_lat" type="text"><span class="master_message inherit">message content</span>
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                      ...
                      <fieldset>
                        <div class="row">
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="Website">@lang('keywords.website')</label>
                              <input class="master_input" type="url" placeholder="ex:www.domain.com" id="Website" name="event[website]"><span class="master_message inherit">message content</span>
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="e_email"> @lang('keywords.email')</label>
                              <input class="master_input" type="email" placeholder="ss@test.com" id="e_email" name="event[email]"><span class="valid-label"></span><span class="master_message inherit">message content</span>
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="Code_numbe">@lang('keywords.code') </label>
                              <input class="master_input" type="number" placeholder="ex: 2012545" id="Code_numbe" name="event[code]"><span class="master_message color--fadegreen">validation message will be here</span>
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="Mobile_number"> @lang('keywords.Phone')</label>
                              <input class="master_input" type="number" placeholder="0123456789" id="Mobile_number" name="event[mobile]"><span class="master_message color--fadegreen">validation message will be here</span>
                            </div>
                          </div>
                        </div>
                      </fieldset>
      ...
      $("#more_workshop").append(`<div><p style="text-align: center;background-color: #1ca6c0;color: azure;">ورشة العمل ${next_count}</p></div>
                      <div class="row">
                        <div class="col-xs-6">
                          <div class="master_field">
                            <label class="master_label" for="workshop_name">اسم ورشة العمل</label>
                            <input class="master_input" type="text" maxlength="100" minlength="2" placeholder="name" id="workshop_name" name="workshop[${next_count}][name]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="master_field">
                            <label class="master_label" for="workshop_description">وصف ورشة العمل </label>
                            <textarea class="master_input"  maxlength="250" minlength="5" id="workshop_description" placeholder="Description" name="workshop[${next_count}][description]"></textarea>@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="master_field">
                            <label class="master_label" for="workshop_venue">مكان ورشة العمل</label>
                            <input class="master_input" type="text" minlength="2" placeholder="ex:CFC" id="workshop_venue"  name="workshop[${next_count}][place]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="master_field">
                            ...
                            <option value="{{$specialization->id}}">{{$specialization->name}}</option>
                            @endforeach
                            </select>@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="master_field">
                        ...
                        <div class="col-xs-6">
                          <div class="master_field">
                            ...
                            </div>@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="master_field">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            <div class="master_field">
                              ...
                              <input class="master_input" type="text" placeholder="question" maxlength="100" minlength="10" id="survey_question" name="survey[${value}][question][${question}][name]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer1">الاجابة رقم 1</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer1" required name="survey[${value}][question][${question}][answer][0]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer2">الاجابة رقم 2</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer2" required name="survey[${value}][question][${question}][answer][1]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer3">الاجابة رقم 3</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer3" name="survey[${value}][question][${question}][answer][2]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer4">الاجابة رقم 4</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer4" name="survey[${value}][question][${question}][answer][3]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          </div>
      `)
                        ...
                        <div class="row">
                          <div class="col-xs-12">
                            <div class="master_field">
                              ...
                              <input class="master_input" type="text" placeholder="question" maxlength="100" minlength="10" id="survey_question" name="survey[0][question][${next_count_question}][name]" required>@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer1">الاجابة رقم 1</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer1" required name="survey[0][question][${next_count_question}][answer][0]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer2">الاجابة رقم 2</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer2" required  name="survey[0][question][${next_count_question}][answer][1]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer3">الاجابة رقم 3</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer3" name="survey[0][question][${next_count_question}][answer][2]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer4">الاجابة رقم 4</label>
                              <input class="master_input" type="text" placeholder="answer" maxlength="100" id="survey_answer4" name="survey[0][question][${next_count_question}][answer][3]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          </div>
                          `
                      ...
                      <div><p style="text-align: center;background-color: #004272;color: azure;">دراسة رقم ${next_count_survey}</p></div>
                        <div class="row">
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_name">الاسم</label>
                              <input class="master_input" type="text"  id="survey_name" name="survey[${next_count_survey}][name]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                          ...
                          <div class="col-xs-12">
                            <div class="master_field">
                              ...
                              <input class="master_input" type="text"  maxlength="100" minlength="10" id="survey_question" name="survey[${next_count_survey}][question][0][name]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer1">الاجابة رقم 1 </label>
                              <input class="master_input" type="text"  maxlength="100" id="survey_answer1" name="survey[${next_count_survey}][question][0][answer][0]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer2">الاجابة رقم 2</label>
                              <input class="master_input" type="text"  maxlength="100" id="survey_answer2" name="survey[${next_count_survey}][question][0][answer][1]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer3">الاجابة رقم 3</label>
                              <input class="master_input" type="text"  maxlength="100" id="survey_answer3" name="survey[${next_count_survey}][question][0][answer][2]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="master_field">
                              <label class="master_label" for="survey_answer4">الاجابة رقم 4</label>
                              <input class="master_input" type="text" maxlength="100" id="survey_answer4" name="survey[${next_count_survey}][question][0][answer][3]">@if ( $errors->has('test') )                   <span class="master_message color--fadegreen">{{ $errors->first('test') }}</span>                 @endif
                            </div>
                          </div>
                        </div>
