            ...
            <div class="col-xs-12">
                ...
                <ul class="tab__content">
                    ...
                    <div class="cardwrap inherit bradius--noborder bshadow--0 padding--small margin--small-top-bottom">
                        ...
                        <label class="master_label" for="cat_id_ar">اضف تصنيف للعروض باللغة العربية</label>
                    ...
                    <div class="cardwrap inherit bradius--noborder bshadow--0 padding--small margin--small-top-bottom">
                        <div class="master_field">
                        <label class="master_label" for="cat_id_en">Add an offer category name in English</label>
            ...
            <div class="tabs--wrapper">
              ...
              <ul class="tab__content">
                <li class="tab__content_item active" id="arabic1-content">
                  <div class="master_field">
                    <label class="master_label" for="cat_id_ar">تعديل تصنيف باللغة العربية</label>
                ...
                <li class="tab__content_item" id="english1-content">
                  <div class="master_field">
                    <label class="master_label" for="cat_id_en">Edit a category in English</label>
