...
<div class="row">
          ...
          <div class="col-xs-12">
            <div class="text-xs-center">         
              <div class="text-wraper">
                ...
                <h4 class="cover-inside-title sub-lvl-2">@lang('keywords.doctorSpecialists')</h4>
              </div>
            </div>
          </div>
            ...
            <table class="data-table-trigger table-master" id="dataTableTriggerId_001">
              <thead>
                <tr class="bgcolor--gray_mm color--gray_d">
                  ...
                  <th><span class="cellcontent">@lang('keywords.doctorSpecialists')</span></th>
                    ...
                    @foreach ($events as $event)
                        <tr data-id="{{ $event->id }}">
                            ...
                            <td><span class="cellcontent">
                                {{ \App::isLocale('en') ? $event->name : Helper::localization('specializations', 'name', $event->id, 2)  }}
                            </span></td>
                            <td>
                                <span class="cellcontent">
                                    <a href="#Edit" data-id="{{ $event->id }}" data-en="{{ $event->name }}" data-arabic="{{ \Helper::localization('specializations', 'name', $event->id, 2) }}" class= "action-btn bgcolor--fadegreen color--white editRow"><i class = "fa  fa-pencil"></i></a>
  ...
  <div class="remodal" data-remodal-id="popupModal_1" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc" id="modal1">
    ...
    <div>
      <div class="row">
        <div class="col-lg-12">
          <h3>@lang('keywords.addNew') @lang('keywords.doctorSpecialists')</h3>
        </div>
            ...
            <div class="col-xs-12">
                ...
                <ul class="tab__content">
                    ...
                    <div class="cardwrap inherit bradius--noborder bshadow--0 padding--small margin--small-top-bottom">
                        ...
                        <label class="master_label mandatory" for="cat_id_ar">اضف تخصص طبيب باللغة العربية</label>
                    ...
                    <div class="cardwrap inherit bradius--noborder bshadow--0 padding--small margin--small-top-bottom">
                        <div class="master_field">
                        <label class="master_label mandatory" for="cat_id_en">Add a doctor specializations in English</label>
  ...
  <div class="remodal" data-remodal-id="Edit" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
    ...
    <div>
      <div class="row">
        <div class="col-lg-12">
          <h3>@lang('keywords.edit') @lang('keywords.doctorSpecialists')</h3>
        </div>
        <div class="col-xs-12">
            ...
            <div class="tabs--wrapper">
              ...
              <ul class="tab__content">
                <li class="tab__content_item active" id="arabic1-content">
                  <div class="master_field">
                    <label class="master_label mandatory" for="cat_id_ar">تعديل الحدث باللغة العربية</label>
                ...
                <li class="tab__content_item" id="english1-content">
                  <div class="master_field">
                    <label class="master_label mandatory" for="cat_id_en">Edit categories in English</label>
