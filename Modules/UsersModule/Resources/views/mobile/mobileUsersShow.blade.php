      ...
      <div class="col-lg-12">
        <div class="coverglobal text-center bshadow--2" style="background:  {{ asset( '/img/covers/dummy2.jpg') }} ; background-position:center center ; background-repeat:no-repeat ;background-size:cover;"><span></span>
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <div class="text-xs-center cont-avatar"><a href="{{route('users_mobile.show', $user->id)}}"><img class="coverglobal__avatar bradius--circle" src="{{asset($user->photo)}}">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12" style="text-align:end;">
            ...
            <form action="{{ route('users_mobile.status.update') }}" method="POST">
                ...
                <div class="div" style="text-align:center;">
                    ...
                    <button class="master-btn   undefined bgcolor--fadebrown  bshadow--0">
